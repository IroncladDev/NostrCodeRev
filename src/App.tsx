...
function App() {
    ...
    const handleZap = async (e: NDKEvent, index: number) => {
        ...
        if (invoice) {
            ...
            if (!!preimage) {
                setPaidEvents((currentPaidEvents) => new Set([...currentPaidEvents, index]));
            }
        }
    };
                    ...
                    .map(({ event }, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {amountSats > 0 ? (
                                    paidEvents.has(index) ? <Check /> :
                                        <Button
                                            onClick={() => handleZap(event, index)}
                                            text={`Zap ⚡ ${amountSats}`}
                                        />
                                ) : null}
                            </div>
